...
| `S` | Show transient: `S s` sort within each group by a column (or click a column header; repeat to flip direction), `S r` open the roots view for the host of the group point is in |
